...
$value_ID = mysqli_real_escape_string($_GET["ID"]);
//$value_Date =  $_GET["Date"];
$value_Date = new DateTime();
$value_Date =  $value_Date->format('Y-m-d H:i:s');
$value_CO = mysqli_real_escape_string($_GET["CO"]);
//$value_CO = $_GET["CO"];
$value_Temp =mysqli_real_escape_string($_GET["t"]);
$value_Hum = mysqli_real_escape_string($_GET["h"]);
$value_Latitude = mysqli_real_escape_string($_GET["La"]);
$value_Longitude = mysqli_real_escape_string($_GET["Lo"]);
